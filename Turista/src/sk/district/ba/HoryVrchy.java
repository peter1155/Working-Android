...
{
	GridView grid;
	private final String TAG = "ba.HoryVrchy";
	int Number_of_items;
	 ...
	 * Reading some ids of Bratislava Region landmarks from DBS.
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Cursor cursor = adapter.getIDS("Bratislavský");
		if(Log.isLoggable(TAG, Log.INFO))
		...
		ll.setBackgroundResource(R.drawable.devin);
		for (i = 0; i < Number_of_items; i++)
		{
