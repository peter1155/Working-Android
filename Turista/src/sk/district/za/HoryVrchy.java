...
{
	GridView grid;
	private final String TAG = "za.HoryVrchy";
	int Number_of_items;
	 ...
	 * Reading some ids of Zilina Region landmarks from DBS.
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Cursor cursor = adapter.getIDS("Žilinský");
		if(Log.isLoggable(TAG, Log.INFO))
		...
		ll.setBackgroundResource(R.drawable.mala_fatra);
		for (i = 0; i < Number_of_items; i++)
		{
