...
{
	GridView grid;
	private final String TAG = "nt.HoryVrchy";
	int Number_of_items;
	 ...
	 * Reading some ids of Nitra Region landmarks from DBS.
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Cursor cursor = adapter.getIDS("Nitriansky");
		if(Log.isLoggable(TAG, Log.INFO))
		...
		ll.setBackgroundResource(R.drawable.gaderska_dolina);
		for (i = 0; i < Number_of_items; i++)
		{
