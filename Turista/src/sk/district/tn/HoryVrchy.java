...
{
	GridView grid;
	private final String TAG = "tn.HoryVrchy";
	int Number_of_items;
	 ...
	 * Reading some ids of Trnava Region landmarks from DBS.
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Cursor cursor = adapter.getIDS("Trnavský");
		if(Log.isLoggable(TAG, Log.INFO))
		...
		ll.setBackgroundResource(R.drawable.vrsatec);
		for (i = 0; i < Number_of_items; i++)
		{
