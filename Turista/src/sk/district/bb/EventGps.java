...
/**
 *  EventGps is class which sets up gps event screen for Banska Bystrica region
 *  
 */
public class EventGps extends EventsGps {
	private static String tag = "bb.EventGps";
	
	
	/** Sets up Banska Bystrica region map as image in imageView
	...
	public void setDefaultImg() {
        ...
        imageView.setImageResource(getResources().getIdentifier("bb", 
