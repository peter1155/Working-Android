...
{
	GridView grid;
	private final String TAG = "bb.HoryVrchy";
	int Number_of_items;
	 ...
	 * Reading some ids of Banska Bystrica Region landmarks from DBS.
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Cursor cursor = adapter.getIDS("Bánsko Bystrický");
		if(Log.isLoggable(TAG, Log.INFO))
		...
		ll.setBackgroundResource(R.drawable.kralova_hola);
		for (i = 0; i < Number_of_items; i++)
		{
