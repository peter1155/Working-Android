...
{
	GridView grid;
	private final String TAG = "tr.HoryVrchy";
	int Number_of_items;
	 ...
	 * Reading some ids of Trencin Region landmarks from DBS.
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Cursor cursor = adapter.getIDS("Trenèianský");
		if(Log.isLoggable(TAG, Log.INFO))
		...
		ll.setBackgroundResource(R.drawable.sulov);
		for (i = 0; i < Number_of_items; i++)
		{
