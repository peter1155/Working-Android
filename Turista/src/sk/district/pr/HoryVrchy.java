...
{
	GridView grid;
	private final String TAG = "pr.HoryVrchy";
	int Number_of_items;
	 ...
	 * Reading some ids of Presov Region landmarks from DBS.
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Cursor cursor = adapter.getIDS("Prešovský");
		if(Log.isLoggable(TAG, Log.INFO))
		...
		ll.setBackgroundResource(R.drawable.tatry);
		for (i = 0; i < Number_of_items; i++)
		{
